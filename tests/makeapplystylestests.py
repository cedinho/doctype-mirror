...
<body>
<p id="breadcrumb">You are here: <a href="../../../index.html">Google Doctype</a> &gt; <a href="../../index.html">Tests</a> &gt; <a href="../index.html">HTML</a> &gt; <a href="index.html">Elements</a> &gt; <b>&lt;%(elementname)s&gt; element applies style%(aschildof)s</b></p>
...
found......control.color <script type="text/javascript">
var actualValue = (encyclopedia.getComputedStyleById('control', 'color') == encyclopedia.getComputedStyleById('test', 'color'));
document.write(actualValue ? '==' : '!=');
document.write(' test.color<' + '/pre><p class=');
...
for wikiname, parentelementname, elementname in [l.strip().split(' ', 2) for l in file('html/elements/elements.txt').readlines() if not l.startswith('#')]:
    ...
    if parentelementname != 'null':
        ...
        aschildof = ''
    testFile += 'applies-style-test.html'
